 ...
 */
inline int
__RSA_Passthrough(void *output, void *input, int size)
{
...
inline rsa_context *
d2i_RSA_PUBKEY(void *ignore, unsigned char **bufptr, int len)
{
...
inline int
RSA_public_decrypt(int size, unsigned char *input, unsigned char *output,
    RSA *key, int ignore)
{
	int outsize = size;
...
inline int
RSA_private_decrypt(int size, unsigned char *input, unsigned char *output,
    RSA *key, int ignore)
{
	int outsize = size;
...
inline int
RSA_public_encrypt(int size, unsigned char *input, unsigned char *output,
    RSA *key, int ignore)
{
...
inline int
RSA_private_encrypt(int size, unsigned char *input, unsigned char *output,
    RSA *key, int ignore)
{
